package com.automation.enterprise;
...
public class Enterprise extends PageBase {

	public UIAction action = new UIAction();

	public Enterprise (final LoadableComponent<?> parent, WebDriver driver) {
	...
	public Enterprise validateTitle() {
